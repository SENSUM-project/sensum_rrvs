...
-- SENSUM RRVS support: tested on version 0.3.1
...
--Load FLOOD Taxonomy attribute tyoe values to the taxonomy tables
...
ALTER VIEW object_res1.ve_resolution1 ALTER BACC SET DEFAULT 'BA99'::character varying;
ALTER VIEW object_res1.ve_resolution1 ALTER BACC_GF SET DEFAULT 'BACC_GF99'::character varying;
ALTER VIEW object_res1.ve_resolution1 ALTER BACC_BK SET DEFAULT 'BACC_BK99'::character varying;
ALTER VIEW object_res1.ve_resolution1 ALTER BACC_BSL SET DEFAULT 'BACC_BSL99'::character varying;
ALTER VIEW object_res1.ve_resolution1 ALTER WNDWS SET DEFAULT 'WNDWS99'::character varying;
...
BEGIN
      ...
      ELSIF TG_OP = 'UPDATE' THEN
       ...
       UPDATE object_res1.main_detail_qualifier SET qualifier_numeric_1=NEW.bacc_bp WHERE detail_id=(SELECT gid FROM object_res1.main_detail WHERE object_id=OLD.gid AND attribute_type_code='BACC');
       UPDATE object_res1.main_detail_qualifier SET qualifier_numeric_1=NEW.bacc_gf_bp WHERE detail_id=(SELECT gid FROM object_res1.main_detail WHERE object_id=OLD.gid AND attribute_type_code='BACC_GF');
       UPDATE object_res1.main_detail_qualifier SET qualifier_numeric_1=NEW.bacc_bk_bp WHERE detail_id=(SELECT gid FROM object_res1.main_detail WHERE object_id=OLD.gid AND attribute_type_code='BACC_BK');
       UPDATE object_res1.main_detail_qualifier SET qualifier_numeric_1=NEW.bacc_bsl_bp WHERE detail_id=(SELECT gid FROM object_res1.main_detail WHERE object_id=OLD.gid AND attribute_type_code='BACC_BSL');
       UPDATE object_res1.main_detail_qualifier SET qualifier_numeric_1=NEW.wndws_bp WHERE detail_id=(SELECT gid FROM object_res1.main_detail WHERE object_id=OLD.gid AND attribute_type_code='WNDWS');
       UPDATE object_res1.main_detail_qualifier SET qualifier_numeric_1=NEW.const_qual_bp WHERE detail_id=(SELECT gid FROM object_res1.main_detail WHERE object_id=OLD.gid AND attribute_type_code='CONST_QUAL');
